...
public class SchoolDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // Apply provider-specific configuration only when using SQLite
        // This keeps SQL Server schema clean while preserving compatibility if SQLite is ever used again
        var isSqliteProvider = Database.ProviderName != null && Database.ProviderName.Contains("Sqlite", StringComparison.OrdinalIgnoreCase);
        if (isSqliteProvider)
        {
            ...
            // Decimal properties mapping for SQLite
            ...
            // BaseEntity date properties mapping for SQLite
